...
2. It is HTMl that enforces other html.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
you cannot set a width and height without inline
...
it allows easy use of multiple people on one project, and saves branches so you can easily revert back.
